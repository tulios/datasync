...
public class TesteBicicleta extends Teste {
	...
	private void clearBicicleta(){
		String[] tabelas = new String[]{
			...
			//responsavel
			"tblResponsavelProblemasTransito",
			"tblResponsavelProblemasTransitoPerspectiva",
			"tblDeslocamento",
			...
			//diretor
			"tblComoAlunosVaoEscola",
			"tblGuardaBicicleta",
			"tblProblemasTransito",
			"tblIdentificacaoDiretor",
			"tblIdentificacaoTransporte",
			"tblCabecalhoDiretor",
			
			//professor
			"tblProfessorProblemasTransito",
			"tblProfessorGuardaBicicleta",
			"tblProfessorComoAlunosVaoEscola",
			"tblIdentificacaoProfessorTransporte",
	...
	private void insertDefaultData(){
		String[] inserts = new String[]{
				...
				"insert into tblTipoDeslocamento values (1, 'Atividade física');",
				"insert into tblTipoProblemasTransito values (1, 'Chuva');",
				"insert into tblTipoGuardaBicicleta values (1, 'Na rua');",
				"insert into tblTipoComoVaoEscola values (1, 'A pé');"
		};
