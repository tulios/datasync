...
public class TesteTblcomoalunosvaoescola extends TesteBicicleta {
    ...
    public void verificaSincronismo() throws Exception{
        ...
        Number local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblcomoalunosvaoescola t").getSingleResult();
        assertEquals(0, local.intValue());

        Number server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblcomoalunosvaoescola t").getSingleResult();
        ...
        Tblcomoalunosvaoescola var = new Tblcomoalunosvaoescola();
        var.setIdformulario("1");
        var.setIdtipocomovaoescola(1);
        var.setQuaisoutros("1");
        getLocalEm().persist(var);

        local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblcomoalunosvaoescola t").getSingleResult();
        ...
        open();
        server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblcomoalunosvaoescola t").getSingleResult();
