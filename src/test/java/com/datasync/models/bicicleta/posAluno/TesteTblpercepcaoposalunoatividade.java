...
public class TesteTblpercepcaoposalunoatividade extends TesteBicicleta {
    ...
    public void verificaSincronismo() throws Exception{
        ...
        Number local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblpercepcaoposalunoatividade t").getSingleResult();
        assertEquals(0, local.intValue());

        Number server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblpercepcaoposalunoatividade t").getSingleResult();
        ...
        Tblpercepcaoposalunoatividade var = new Tblpercepcaoposalunoatividade();
        var.setIdtipoatividade(1);
        var.setIdformulario("1");
        var.setQuaisoutros("1");
        getLocalEm().persist(var);

        local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblpercepcaoposalunoatividade t").getSingleResult();
        ...
        open();
        server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblpercepcaoposalunoatividade t").getSingleResult();
