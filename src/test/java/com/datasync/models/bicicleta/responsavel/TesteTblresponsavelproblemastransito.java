...
public class TesteTblresponsavelproblemastransito extends TesteBicicleta {
    ...
    public void verificaSincronismo() throws Exception{
        ...
        Number local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblresponsavelproblemastransito t").getSingleResult();
        assertEquals(0, local.intValue());

        Number server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblresponsavelproblemastransito t").getSingleResult();
        ...
        Tblresponsavelproblemastransito var = new Tblresponsavelproblemastransito();
        var.setIdformulario("1");
        var.setIdtipoproblemastransito(1);
        var.setQuaisoutros("1");
        getLocalEm().persist(var);

        local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblresponsavelproblemastransito t").getSingleResult();
        ...
        open();
        server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblresponsavelproblemastransito t").getSingleResult();
