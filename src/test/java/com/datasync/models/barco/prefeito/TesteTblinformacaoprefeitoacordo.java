...
public class TesteTblinformacaoprefeitoacordo extends TesteBarco {
    ...
    public void verificaSincronismo() throws Exception{
        ...
        Number local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblinformacaoprefeitoacordo t").getSingleResult();
        assertEquals(0, local.intValue());

        Number server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblinformacaoprefeitoacordo t").getSingleResult();
        ...
        Tblinformacaoprefeitoacordo var = new Tblinformacaoprefeitoacordo();
        ...
        local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblinformacaoprefeitoacordo t").getSingleResult();
        ...
        open();
        server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblinformacaoprefeitoacordo t").getSingleResult();
