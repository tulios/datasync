...
public class TesteTblcaracterizacaodiretoroutraexperiencia extends TesteBarco {
    ...
    public void verificaSincronismo() throws Exception{
        ...
        Number local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblcaracterizacaodiretoroutraexperiencia t").getSingleResult();
        assertEquals(0, local.intValue());

        Number server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblcaracterizacaodiretoroutraexperiencia t").getSingleResult();
        ...
        Tblcaracterizacaodiretoroutraexperiencia var = new Tblcaracterizacaodiretoroutraexperiencia();
        var.setIdtipooutraexperiencia(1);
        var.setIdformulario("1");
        var.setQuaisoutras("teste");
        getLocalEm().persist(var);

        local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblcaracterizacaodiretoroutraexperiencia t").getSingleResult();
        ...
        open();
        server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblcaracterizacaodiretoroutraexperiencia t").getSingleResult();
