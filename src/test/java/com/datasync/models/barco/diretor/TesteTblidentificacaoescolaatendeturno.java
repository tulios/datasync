...
public class TesteTblidentificacaoescolaatendeturno extends TesteBarco {
    ...
    public void verificaSincronismo() throws Exception{
        ...
        Number local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblidentificacaoescolaatendeturno t").getSingleResult();
        assertEquals(0, local.intValue());

        Number server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblidentificacaoescolaatendeturno t").getSingleResult();
        ...
        Tblidentificacaoescolaatendeturno var = new Tblidentificacaoescolaatendeturno();
        var.setIdformulario("1");
        var.setIdtipoturno(1);
        getLocalEm().persist(var);

        local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblidentificacaoescolaatendeturno t").getSingleResult();
        ...
        open();
        server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblidentificacaoescolaatendeturno t").getSingleResult();
