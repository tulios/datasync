...
public class TesteTblinformacaopaisbarcoatrasa extends TesteBarco {
    ...
    public void verificaSincronismo() throws Exception{
        ...
        Number local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblinformacaopaisbarcoatrasa t").getSingleResult();
        assertEquals(0, local.intValue());

        Number server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblinformacaopaisbarcoatrasa t").getSingleResult();
        ...
        Tblinformacaopaisbarcoatrasa var = new Tblinformacaopaisbarcoatrasa();
        var.setIdformulario("1");
        var.setIdtipoprovidenciapai(1);
        var.setQuemoutro("1");
        getLocalEm().persist(var);

        local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblinformacaopaisbarcoatrasa t").getSingleResult();
        ...
        open();
        server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblinformacaopaisbarcoatrasa t").getSingleResult();
