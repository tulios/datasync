...
public class TesteTblinformacaopaisalunonaoescola extends TesteBarco {
    ...
    public void verificaSincronismo() throws Exception{
        ...
        Number local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblinformacaopaisalunonaoescola t").getSingleResult();
        assertEquals(0, local.intValue());

        Number server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblinformacaopaisalunonaoescola t").getSingleResult();
        ...
        Tblinformacaopaisalunonaoescola var = new Tblinformacaopaisalunonaoescola();
        var.setIdformulario("1");
        var.setIdtipoalunonaoescola(1);
        var.setQualoutro("1");
        getLocalEm().persist(var);

        local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblinformacaopaisalunonaoescola t").getSingleResult();
        ...
        open();
        server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblinformacaopaisalunonaoescola t").getSingleResult();
