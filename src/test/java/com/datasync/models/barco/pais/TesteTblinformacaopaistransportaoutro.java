...
public class TesteTblinformacaopaistransportaoutro extends TesteBarco {
    ...
    public void verificaSincronismo() throws Exception{
        ...
        Number local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblinformacaopaistransportaoutro t").getSingleResult();
        assertEquals(0, local.intValue());

        Number server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblinformacaopaistransportaoutro t").getSingleResult();
        ...
        Tblinformacaopaistransportaoutro var = new Tblinformacaopaistransportaoutro();
        var.setIdformulario("1");
        var.setIdtipooutroacompanhante(1);
        var.setQuemoutro("1");
        getLocalEm().persist(var);

        local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblinformacaopaistransportaoutro t").getSingleResult();
        ...
        open();
        server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblinformacaopaistransportaoutro t").getSingleResult();
