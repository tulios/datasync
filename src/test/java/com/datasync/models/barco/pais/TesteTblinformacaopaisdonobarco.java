...
public class TesteTblinformacaopaisdonobarco extends TesteBarco {
    ...
    public void verificaSincronismo() throws Exception{
        ...
        Number local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblinformacaopaisdonobarco t").getSingleResult();
        assertEquals(0, local.intValue());

        Number server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblinformacaopaisdonobarco t").getSingleResult();
        ...
        Tblinformacaopaisdonobarco var = new Tblinformacaopaisdonobarco();
        var.setIdtipodonobarco(1);
        var.setIdformulario("1");
        var.setQuem("1");
        getLocalEm().persist(var);

        local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblinformacaopaisdonobarco t").getSingleResult();
        ...
        open();
        server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblinformacaopaisdonobarco t").getSingleResult();
