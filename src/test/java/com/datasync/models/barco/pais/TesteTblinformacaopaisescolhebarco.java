...
public class TesteTblinformacaopaisescolhebarco extends TesteBarco {
    ...
    public void verificaSincronismo() throws Exception{
        ...
        Number local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblinformacaopaisescolhebarco t").getSingleResult();
        assertEquals(0, local.intValue());

        Number server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblinformacaopaisescolhebarco t").getSingleResult();
        ...
        Tblinformacaopaisescolhebarco var = new Tblinformacaopaisescolhebarco();
        var.setIdtipoescolhebarco(1);
        var.setIdformulario("1");
        var.setQuemoutro("1");
        getLocalEm().persist(var);

        local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblinformacaopaisescolhebarco t").getSingleResult();
        ...
        open();
        server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblinformacaopaisescolhebarco t").getSingleResult();
