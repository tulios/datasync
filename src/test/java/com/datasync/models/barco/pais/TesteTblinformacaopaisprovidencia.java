...
public class TesteTblinformacaopaisprovidencia extends TesteBarco {
    ...
    public void verificaSincronismo() throws Exception{
        ...
        Number local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblinformacaopaisprovidencia t").getSingleResult();
        assertEquals(0, local.intValue());

        Number server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblinformacaopaisprovidencia t").getSingleResult();
        ...
        Tblinformacaopaisprovidencia var = new Tblinformacaopaisprovidencia();
        var.setIdformulario("1");
        var.setIdtipoprovidenciapai(1);
        var.setQuemoutro("1");
        getLocalEm().persist(var);

        local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblinformacaopaisprovidencia t").getSingleResult();
        ...
        open();
        server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblinformacaopaisprovidencia t").getSingleResult();
