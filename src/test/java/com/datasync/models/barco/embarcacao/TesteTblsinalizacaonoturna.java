...
public class TesteTblsinalizacaonoturna extends TesteBarco {
    ...
    public void verificaSincronismo() throws Exception{
        ...
        Number local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblsinalizacaonoturna t").getSingleResult();
        assertEquals(0, local.intValue());

        Number server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblsinalizacaonoturna t").getSingleResult();
        ...
        Tblsinalizacaonoturna var = new Tblsinalizacaonoturna();
        var.setIdtiposinalizacao(1);
        var.setIdformulario("1");
        var.setQuaisoutras("quais");
        getLocalEm().persist(var);

        local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblsinalizacaonoturna t").getSingleResult();
        ...
        open();
        server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblsinalizacaonoturna t").getSingleResult();
