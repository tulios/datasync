...
public class TesteTblpercepcaoprofessoralunoreclama extends TesteBarco {
    ...
    public void verificaSincronismo() throws Exception{
        ...
        Number local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblpercepcaoprofessoralunoreclama t").getSingleResult();
        assertEquals(0, local.intValue());

        Number server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblpercepcaoprofessoralunoreclama t").getSingleResult();
        ...
        Tblpercepcaoprofessoralunoreclama var = new Tblpercepcaoprofessoralunoreclama();
        ...
        local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblpercepcaoprofessoralunoreclama t").getSingleResult();
        ...
        open();
        server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblpercepcaoprofessoralunoreclama t").getSingleResult();
