...
public class TesteTblpercepcaoprofessoravisoaluno extends TesteBarco {
    ...
    public void verificaSincronismo() throws Exception{
        ...
        Number local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblpercepcaoprofessoravisoaluno t").getSingleResult();
        assertEquals(0, local.intValue());

        Number server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblpercepcaoprofessoravisoaluno t").getSingleResult();
        ...
        Tblpercepcaoprofessoravisoaluno var = new Tblpercepcaoprofessoravisoaluno();
        var.setIdtipoavisoaluno(1);
        var.setIdformulario("1");
        var.setAlunoassisteaula("Sim");
        var.setQualoutro("Outro");
        getLocalEm().persist(var);

        local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblpercepcaoprofessoravisoaluno t").getSingleResult();
        ...
        open();
        server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblpercepcaoprofessoravisoaluno t").getSingleResult();
