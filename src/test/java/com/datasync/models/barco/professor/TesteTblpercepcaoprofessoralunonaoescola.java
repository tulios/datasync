...
public class TesteTblpercepcaoprofessoralunonaoescola extends TesteBarco {
    ...
    public void verificaSincronismo() throws Exception{
        ...
        Number local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblpercepcaoprofessoralunonaoescola t").getSingleResult();
        assertEquals(0, local.intValue());

        Number server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblpercepcaoprofessoralunonaoescola t").getSingleResult();
        ...
        Tblpercepcaoprofessoralunonaoescola var = new Tblpercepcaoprofessoralunonaoescola();
        var.setIdtipoalunonaoescola(1);
        var.setIdformulario("1");
        var.setCriancanaoescola("Sim");
        var.setOutrosquais("Outro");
        getLocalEm().persist(var);

        local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblpercepcaoprofessoralunonaoescola t").getSingleResult();
        ...
        open();
        server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblpercepcaoprofessoralunonaoescola t").getSingleResult();
