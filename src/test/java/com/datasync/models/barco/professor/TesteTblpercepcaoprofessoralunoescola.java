...
public class TesteTblpercepcaoprofessoralunoescola extends TesteBarco {
    ...
    public void verificaSincronismo() throws Exception{
        ...
        Number local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblpercepcaoprofessoralunoescola t").getSingleResult();
        assertEquals(0, local.intValue());

        Number server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblpercepcaoprofessoralunoescola t").getSingleResult();
        ...
        Tblpercepcaoprofessoralunoescola var = new Tblpercepcaoprofessoralunoescola();
        var.setIdtipooutrotransporte(1);
        var.setIdformulario("1");
        var.setOutrosquais("Outro");
        getLocalEm().persist(var);

        local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblpercepcaoprofessoralunoescola t").getSingleResult();
        ...
        open();
        server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblpercepcaoprofessoralunoescola t").getSingleResult();
