...
public class TesteTblcaracterizacaofamiliaalunotrabalho extends TesteBarco {
    ...
    public void verificaSincronismo() throws Exception{
        ...
        Number local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblcaracterizacaofamiliaalunotrabalho t").getSingleResult();
        assertEquals(0, local.intValue());

        Number server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblcaracterizacaofamiliaalunotrabalho t").getSingleResult();
        ...
        Tblcaracterizacaofamiliaalunotrabalho var = new Tblcaracterizacaofamiliaalunotrabalho();
        var.setIdformulario("1");
        var.setIdtipotrabalho(1);
        var.setDescricaoajuda("Desc");
        getLocalEm().persist(var);

        local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblcaracterizacaofamiliaalunotrabalho t").getSingleResult();
        ...
        open();
        server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblcaracterizacaofamiliaalunotrabalho t").getSingleResult();
