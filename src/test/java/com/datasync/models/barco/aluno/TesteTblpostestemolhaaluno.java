...
public class TesteTblpostestemolhaaluno extends TesteBarco {
    ...
    public void verificaSincronismo() throws Exception{
        ...
        Number local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblpostestemolhaaluno t").getSingleResult();
        assertEquals(0, local.intValue());

        Number server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblpostestemolhaaluno t").getSingleResult();
        ...
        Tblpostestemolhaaluno var = new Tblpostestemolhaaluno();
        var.setIdformulario("1");
        var.setIdtipomolhaaluno(1);
        var.setMolhoualuno("Sim");
        getLocalEm().persist(var);

        local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblpostestemolhaaluno t").getSingleResult();
        ...
        open();
        server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblpostestemolhaaluno t").getSingleResult();
