...
public class TesteTblpercepcaoalunomelhoria extends TesteBarco {
    ...
    public void verificaSincronismo() throws Exception{
        ...
        Number local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblpercepcaoalunomelhoria t").getSingleResult();
        assertEquals(0, local.intValue());

        Number server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblpercepcaoalunomelhoria t").getSingleResult();
        ...
        Tblpercepcaoalunomelhoria var = new Tblpercepcaoalunomelhoria();
        var.setIdformulario("1");
        var.setIdmelhoria(1);
        var.setQualoutro("Outro");
        getLocalEm().persist(var);

        local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblpercepcaoalunomelhoria t").getSingleResult();
        ...
        open();
        server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblpercepcaoalunomelhoria t").getSingleResult();
