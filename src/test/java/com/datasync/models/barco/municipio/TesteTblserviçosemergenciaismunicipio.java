...
public class TesteTblserviçosemergenciaismunicipio extends TesteBarco {
    ...
    public void verificaSincronismo() throws Exception{
        ...
        indexables.add(new Tblserviçosemergenciaismunicipio());
        ...
        Tblserviçosemergenciaismunicipio var = new Tblserviçosemergenciaismunicipio();
