...
public class TesteTblpostoabastecimento3 extends TesteBarco {
    ...
    public void verificaSincronismo() throws Exception{
        ...
        Number local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblpostoabastecimento3 t").getSingleResult();
        assertEquals(0, local.intValue());

        Number server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblpostoabastecimento3 t").getSingleResult();
        ...
        Tblpostoabastecimento3 var = new Tblpostoabastecimento3();
        ...
        local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblpostoabastecimento3 t").getSingleResult();
        ...
        open();
        server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblpostoabastecimento3 t").getSingleResult();
