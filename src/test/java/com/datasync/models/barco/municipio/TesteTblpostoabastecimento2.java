...
public class TesteTblpostoabastecimento2 extends TesteBarco {
    ...
    public void verificaSincronismo() throws Exception{
        ...
        Number local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblpostoabastecimento2 t").getSingleResult();
        assertEquals(0, local.intValue());

        Number server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblpostoabastecimento2 t").getSingleResult();
        ...
        Tblpostoabastecimento2 var = new Tblpostoabastecimento2();
        ...
        local = (Number) getLocalEm().createQuery("select count(t.idformulario) from Tblpostoabastecimento2 t").getSingleResult();
        ...
        open();
        server = (Number) getServerEm().createQuery("select count(t.idformulario) from Tblpostoabastecimento2 t").getSingleResult();
