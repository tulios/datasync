...
@Entity
@Table(name = "tblIdentificacaoTransporte")
@SuppressWarnings("serial")
public class Tblidentificacaotransporte extends IndexableEntity{

    @Id
    @Column(name = "IdFormulario")
    private String idformulario;
    @Column(name = "QuantidadeAlunoEscola")
    private Integer quantidadealunoescola;
    ...
    public void setQuantidadealunoescola(Integer quantidadealunoescola){
        this.quantidadealunoescola = quantidadealunoescola;
    }

    public Integer getQuantidadealunoescola(){
        return quantidadealunoescola;
    }
