    ...
    def generate_tests
      ...
      @tables.each do |table|
        ...
        File.open("#{@path}/test/#{test}.java", "w") do |file|
          ...
          file.puts "import com.datasync.service.SyncDatabasesService;"
          file.puts "import com.datasync.service.runner.ServiceRunner;"
          file.puts "import com.datasync.service.runner.SyncServiceRunner;"
          file.puts ""
          ...
          file.puts ""
          file.puts "#{TAB2}ServiceRunner runner = new SyncServiceRunner();"
          file.puts "#{TAB2}runner.run(new SyncDatabasesService(indexables));"   
          file.puts ""
